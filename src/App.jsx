...
const App = () => {
    ...
    return (
        <div className="bg-gray-100 flex flex-col items-center min-h-screen h-auto">
            <h1 className="text-3xl sm:text-4xl font-bold p-5 sm:p-10 mt-5 sm:mt-10 text-center">
            ...
            <div className="w-full max-w-lg sm:max-w-xl relative mt-5 sm:mt-0">
                {/* Search input */}
                <input
                    className="w-full p-3 sm:p-4 text-base sm:text-lg border border-gray-300 rounded-full focus:outline-none focus:border-blue-500 focus:ring focus:ring-blue-200 shadow-sm mt-5 sm:mt-20"
                    onChange={(e) => {
